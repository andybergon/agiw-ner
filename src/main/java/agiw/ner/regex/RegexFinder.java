...
public class RegexFinder {
	...
	public static final String JOB_START = "Arch|Avv|Dott|Comm|Don|Dott\\.sa|Dott\\.ssa|Dottor|Dott|Dr|Geom|Ill\\.mo|Ing|Mo|Mons|On\\.|"
			+ "P\\.Avv|Prof\\.sa|Prof\\.ssa|Prof|Rag|Rev|Sen|Ten|Uff";
	// "Gen|GUP|PM|SA|SE|SS"
	...
	public static void main(String[] args) {
		...
		String addressTest = "via matteotti 8. via metada, 8. via sant'agostino 1.via sant' agostino 1, mia Via Eschiclo, 21. luca: viale amster casav 33/34/35/c, chiara è largo adjj ee 22/b e bla. ";
		...
		List<String> allMatches = rf.findRegexInString(ADDRESS_REGEX, test);
